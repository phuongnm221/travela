...
<script src="<?php echo e(asset('admin/vendors/echarts/dist/echarts.min.js')); ?>"></script>
<!-- gauge.js -->
...
<script src="<?php echo e(asset('admin/build/js/custom.js')); ?>"></script>
<!-- jQuery Smart Wizard -->
<script src="<?php echo e(asset('admin/vendors/jQuery-Smart-Wizard/js/jquery.smartWizard.js')); ?>"></script>

<script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>


<script src="<?php echo e(asset('admin/assets/js/ckeditor/ckeditor.js')); ?>"></script>


<script src="<?php echo e(asset('admin/assets/js/jquery.datetimepicker.full.min.js')); ?>"></script>
<!-- Custom Scripts By DevDien -->
<script src="<?php echo e(asset('admin/assets/js/custom-js.js')); ?>"></script>
...
;(function(){
	...
	if ($btn.length && $.fn.popover) {
		var deleteUrl = '<?php echo e(route('admin.delete-contact')); ?>';
...
<?php /**PATH D:\xampp\htdocs\travela\resources\views/admin/blocks/footer.blade.php ENDPATH**/ ?>