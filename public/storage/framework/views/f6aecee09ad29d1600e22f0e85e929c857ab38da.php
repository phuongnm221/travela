...
<section class="hero-area bgc-black pt-200 rpt-120 rel z-2">
    <div class="container-fluid">
        <h1 class="hero-title" data-aos="flip-up" data-aos-delay="50" data-aos-duration="1500" data-aos-offset="50">
            ĐỒNG HÀNH TRÊN MỌI HÀNH TRÌNH </h1>
        <div class="main-hero-image bgs-cover"
            style="background-image: url(<?php echo e(asset('clients/assets/images/hero/banner2.jpg')); ?>);">
        </div>
    </div>
...
<!-- Hero Area End -->
<?php /**PATH D:\xampp\htdocs\travela\resources\views/clients/blocks/banner_home.blade.php ENDPATH**/ ?>