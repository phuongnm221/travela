        ...
        <div class="container">
            <div class="row gap-10 destinations-active justify-content-center">
                ...
                <?php $__currentLoopData = $tours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($count % 3 == 2): ?>
                        <div class="col-md-6 item domain-<?php echo e($tour->domain); ?>">
                        <?php else: ?>
                            <div class="col-xl-3 col-md-6 item domain-<?php echo e($tour->domain); ?>">
                    <?php endif; ?>
...
<?php /**PATH D:\xampp\htdocs\travela\resources\views/clients/destination.blade.php ENDPATH**/ ?>