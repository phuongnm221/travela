    ...
    public function handleGoogleCallback()
    {
        try {
            ...
            if ($user) {
                ...
                return redirect('/clients/dashboard')->with('success', 'Đăng nhập bằng Google thành công!');
            } else {
                ...
                if ($existingUser) {
                    ...
                    Auth::loginUsingId($existingUser->userId, true);
                    return redirect('/clients/dashboard')->with('success', 'Liên kết Google thành công!');
                }
                ...
                return redirect('/clients/dashboard')->with('success', 'Đăng ký và đăng nhập thành công!');
            }
        } catch (\Exception $e) {
