...
class User extends Model
{
    ...
    protected $fillable = ['email', 'username', 'password', 'fullName', 'avatar', 'phoneNumber', 'address', 'isActive', 'status', 'reset_token', 'activation_token', 'activation_token_expires', 'is_activated'];
