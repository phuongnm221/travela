<?php echo $__env->make('clients.blocks.header_home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('clients.blocks.banner_home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <?php $__currentLoopData = $tours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-xxl-3 col-xl-4 col-md-6" style="margin-bottom: 30px">
                    <div class="destination-item block_tours" data-aos="fade-up" data-aos-duration="1500"
                        data-aos-offset="50">
                        <div class="image">
                            <div class="ratting"><i class="fas fa-star"></i> <?php echo e(number_format($tour->rating, 1)); ?></div>
                            <a href="#" class="heart"><i class="fas fa-heart"></i></a>
                            <img src="<?php echo e(asset('admin/assets/images/gallery-tours/' . $tour->images[0] . '')); ?>"
                                alt="Destination">
                        </div>
                        <div class="content">
                            <span class="location"><i class="fal fa-map-marker-alt"></i><?php echo e($tour->destination); ?></span>
                            <h5><a href="<?php echo e(route('tour-detail', ['id' => $tour->tourId])); ?>"><?php echo e($tour->title); ?></a>
                            </h5>
                            <span class="time"><?php echo e($tour->time); ?></span>
                        </div>
                        <div class="destination-footer">
                            <span class="price"><span><?php echo e(number_format($tour->priceAdult, 0, ',', '.')); ?></span> VND /
                                người</span>
                            <a href="<?php echo e(route('tour-detail', ['id' => $tour->tourId])); ?>" class="read-more">Đặt ngay <i
        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-7 col-lg-6" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                <div class="about-us-image">
                    <div class="shape"><img src="<?php echo e(asset('clients/assets/images/about/shape1.png')); ?>" alt="Shape">
                    </div>
                    <div class="shape"><img src="<?php echo e(asset('clients/assets/images/about/shape2.png')); ?>" alt="Shape">
                    </div>
                    <div class="shape"><img src="<?php echo e(asset('clients/assets/images/about/shape3.png')); ?>"
                            alt="Shape"></div>
                    <div class="shape"><img src="<?php echo e(asset('clients/assets/images/about/shape4.png')); ?>"
                            alt="Shape"></div>
                    <div class="shape"><img src="<?php echo e(asset('clients/assets/images/about/shape5.png')); ?>"
                            alt="Shape"></div>
                    <div class="shape"><img src="<?php echo e(asset('clients/assets/images/about/shape6.png')); ?>"
                            alt="Shape"></div>
                    <div class="shape"><img src="<?php echo e(asset('clients/assets/images/about/shape7.png')); ?>"
                            alt="Shape"></div>
                    <img src="<?php echo e(asset('clients/assets/images/about/about.png')); ?>" alt="About">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <?php $__currentLoopData = $toursPopular; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="destination-item style-two" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="content">
                                ...
                                <span class="time"><?php echo e($tour->time); ?></span>
                                <a href="<?php echo e(route('tour-detail', ['id' => $tour->tourId])); ?>" class="more"><i
            ...
            <div class="col-xl-6">
                <div class="features-content-part mb-55" data-aos="fade-left" data-aos-duration="1500"
                    ...
                    <div class="features-customer-box">
                        <div class="image">
                            <img src="<?php echo e(asset('clients/assets/images/features/features-box.jpg')); ?>" alt="Features">
                        </div>
                        <div class="content">
                            <div class="feature-authors mb-15">
                                <img src="<?php echo e(asset('clients/assets/images/features/feature-author1.jpg')); ?>"
                                    alt="Author">
                                <img src="<?php echo e(asset('clients/assets/images/features/feature-author2.jpg')); ?>"
                                    alt="Author">
                                <img src="<?php echo e(asset('clients/assets/images/features/feature-author3.jpg')); ?>"
                                    alt="Author">
                                <span>4k+</span>
                            </div>
                ...
                <div class="row pb-25">
                    <div class="col-md-6">
                        <div class="feature-item">
                            ...
                            <div class="content">
                                <h5><a href="<?php echo e(route('tours')); ?>">Chinh Phục Cảnh Quan Việt Nam</a></h5>
                        ...
                        <div class="feature-item">
                            <div class="icon"><i class="flaticon-tent"></i></div>
                            <div class="content">
                                <h5><a href="<?php echo e(route('tours')); ?>">Trải Nghiệm Đặc Sắc Việt Nam</a></h5>
                    ...
                    <div class="col-md-6">
                        <div class="feature-item mt-20">
                            <div class="icon"><i class="flaticon-tent"></i></div>
                            <div class="content">
                                <h5><a href="<?php echo e(route('tours')); ?>">Khám Phá Di Sản Việt Nam</a></h5>
                        ...
                        <div class="feature-item">
                            <div class="icon"><i class="flaticon-tent"></i></div>
                            <div class="content">
                                <h5><a href="<?php echo e(route('tours')); ?>">Vẻ Đẹp Thiên Nhiên Việt </a></h5>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-4 col-md-6" data-aos="zoom-in-down" data-aos-duration="1500" data-aos-offset="50">
                <div class="cta-item"
                    style="background-image: url( <?php echo e(asset('clients/assets/images/cta/cta1.jpg')); ?>);">
            ...
            <div class="col-xl-4 col-md-6" data-aos="zoom-in-down" data-aos-delay="50" data-aos-duration="1500"
                data-aos-offset="50">
                <div class="cta-item"
                    style="background-image: url( <?php echo e(asset('clients/assets/images/cta/cta2.jpg')); ?>);">
                    <span class="category">Bãi biển Sea</span>
                    <h2>Bãi trong xanh dạt dào ở Việt Nam</h2>
                    <a href="<?php echo e(route('tours')); ?>" class="theme-btn style-two">
                        <span data-hover="Khám phá">Khám phá</span>
                        <i class="fal fa-arrow-right"></i>
                    </a>
                </div>
            ...
            <div class="col-xl-4 col-md-6" data-aos="zoom-in-down" data-aos-delay="100" data-aos-duration="1500"
                data-aos-offset="50">
                <div class="cta-item"
                    style="background-image: url( <?php echo e(asset('clients/assets/images/cta/cta3.jpg')); ?>);">
...
<?php echo $__env->make('clients.blocks.footer_home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH C:\xampp\htdocs\travela-master\travela-master\resources\views/clients/home.blade.php ENDPATH**/ ?>