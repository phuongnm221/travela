                                        ...
                                        <div class="card-box table-responsive">
                                            ...
                                            <table id="datatable-listTours" class="table table-striped table-bordered"
                                                ...
                                                <tbody id="tbody-listTours">
                                                    <?php echo $__env->make('admin.partials.list-tours', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div id="wizard" class="form_wizard wizard_horizontal wizard-edit-tour">
                            ...
                            <form action="<?php echo e(route('admin.edit-tour')); ?>" id="timeline-form" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\travela-master\travela-master\resources\views/admin/tours.blade.php ENDPATH**/ ?>