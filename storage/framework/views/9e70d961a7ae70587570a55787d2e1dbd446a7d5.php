...
<head>
    ...
    <link href="<?php echo e(asset('admin/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css')); ?>"
        rel="stylesheet">
    <!-- JQVMap -->
    ...
    <link href="<?php echo e(asset('admin/vendors/datatables.net-buttons-bs/css/buttons.bootstrap.min.css')); ?>"
        rel="stylesheet" />
    <link href="<?php echo e(asset('admin/vendors/datatables.net-fixedheader-bs/css/fixedHeader.bootstrap.min.css')); ?>"
        rel="stylesheet" />
    <link href="<?php echo e(asset('admin/vendors/datatables.net-responsive-bs/css/responsive.bootstrap.min.css')); ?>"
        rel="stylesheet" />
    <link href="<?php echo e(asset('admin/vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css')); ?>"
        rel="stylesheet" />
    ...
    <link href="<?php echo e(asset('admin/assets/css/jquery.datetimepicker.min.css')); ?>" rel="stylesheet">
...
<body class="nav-md">
<?php /**PATH C:\xampp\htdocs\travela-master\travela-master\resources\views/admin/blocks/header.blade.php ENDPATH**/ ?>