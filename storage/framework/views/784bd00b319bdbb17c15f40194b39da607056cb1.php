...
<section class="newsletter-three bgc-primary py-100 rel z-1"
    style="background-image: url(<?php echo e(asset('clients/assets/images/newsletter/newsletter-bg-lines.png')); ?>);">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="newsletter-bg-image" data-aos="zoom-in-up" data-aos-delay="100" data-aos-duration="1500"
                    data-aos-offset="50">
                    <img src="<?php echo e(asset('clients/assets/images/newsletter/newsletter-bg-image.png')); ?>"
                        alt="Newsletter">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="newsletter-image-part bgs-cover"
                    style="background-image: url(<?php echo e(asset('clients/assets/images/newsletter/newsletter-two-right.jpg')); ?>);"
                    data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50"></div>
            </div>
        </div>
    </div>
</section>
<!-- Newsletter Area end --><?php /**PATH C:\xampp\htdocs\travela-master\travela-master\resources\views/clients/blocks/new_letter.blade.php ENDPATH**/ ?>