                                        ...
                                        <div class="card-box table-responsive">
                                            ...
                                            <table id="datatable-booking" class="table table-striped table-bordered"
                                                ...
                                                <tbody id="tbody-booking">
                                                    <?php echo $__env->make('admin.partials.list-booking', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
...
<?php /**PATH C:\xampp\htdocs\travela-master\travela-master\resources\views/admin/booking.blade.php ENDPATH**/ ?>