        ...
        <div class="row">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        <img id="avatarPreview" class="img-account-profile rounded-circle mb-2"
                            src="<?php echo e(asset('admin/assets/images/user-profile/' . $user->avatar)); ?>"
                            style="width:160px; height: 160px;" alt="Ảnh đại diện <?php echo e($user->avatar); ?>">
                        ...
                        <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" class="__token">
                        <input type="hidden" name="" value="<?php echo e(route('change-avatar')); ?>" class="label_avatar">
            ...
            <div class="col-xl-8">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('update-user-profile')); ?>" method="POST" name="updateUser"
                            class="updateUser">
                            <div class="row gx-3 mb-3">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="inputFullName" type="text" name="fullName"
                                        placeholder="Họ và tên" value="<?php echo e($user->fullName); ?>" required>
                                </div>
                            </div>
                            <?php echo csrf_field(); ?>
                            <div class="row gx-3 mb-3">
                            ...
                            <div class="row gx-3 mb-3">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="inputPhone" type="text" name="phoneNumber"
                                        placeholder="Số điện thoại" value="<?php echo e($user->phoneNumber); ?>" 
                                        pattern="^\d{10}$" 
                ...
                <div class="card mb-4 ">
                    <div class="card-body" id="card_change_password">
                        ...
                        <form action="<?php echo e(route('change-password')); ?>" method="post" class="change_password_profile">
                            <?php echo csrf_field(); ?>
                            <div class="row gx-3">
                                <div class="col-md-4">
...
<?php /**PATH C:\xampp\htdocs\travela-master\travela-master\resources\views/clients/user-profile.blade.php ENDPATH**/ ?>