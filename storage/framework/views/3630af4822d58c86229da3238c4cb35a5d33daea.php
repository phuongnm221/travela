                ...
                <div class="about-page-content" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <a href="<?php echo e(route('tours')); ?>" class="theme-btn style-three mt-30">
        ...
        <div class="row align-items-center">
            <div class="col-xl-4 col-md-6">
                <div class="about-feature-image" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <img src="<?php echo e(asset('clients/assets/images/about/about-feature1.jpg')); ?>" alt="About">
                </div>
            </div>
            <div class="col-xl-4 col-md-6">
                <div class="about-feature-image" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1500"
                    data-aos-offset="50">
                    <img src="<?php echo e(asset('clients/assets/images/about/about-feature2.jpg')); ?>" alt="About">
                </div>
            </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-7 col-lg-6" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                <div class="about-us-page">
                    <img src="<?php echo e(asset('clients/assets/images/about/about-page.jpg')); ?>" alt="About">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="team-item hover-content" data-aos="fade-up" data-aos-duration="1500"
                    data-aos-offset="50">
                    <img src="<?php echo e(asset('clients/assets/images/team/guide-dien.jpg')); ?>" alt="Guide">
                    <div class="content">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="team-item hover-content" data-aos="fade-up" data-aos-duration="1500"
                    data-aos-offset="50">
                    <img src="<?php echo e(asset('clients/assets/images/team/guide-ngan.jpg')); ?>" alt="Guide">
                    <div class="content">
                        <h6>BAO NGAN</h6>
...
<section class="about-feature-two bgc-black pt-100 pb-45 rel z-1">
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1500"
                ...
                <div class="feature-item style-two">
                    ...
                    <div class="content">
                        <h5><a href="<?php echo e(route('tours')); ?>">Đảm bảo giá tốt nhất</a></h5>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1500"
                ...
                <div class="feature-item style-two">
                    ...
                    <div class="content">
                        <h5><a href="<?php echo e(route('tours')); ?>">Điểm đến đa dạng</a></h5>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1500"
                ...
                <div class="feature-item style-two">
                    ...
                    <div class="content">
                        <h5><a href="<?php echo e(route('tours')); ?>">Đặt chỗ nhanh</a></h5>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="150" data-aos-duration="1500"
                ...
                <div class="feature-item style-two">
                    ...
                    <div class="content">
                        <h5><a href="<?php echo e(route('tours')); ?>">Hướng dẫn du lịch tốt</a></h5>
    ...
    <div class="shape">
        <img src="<?php echo e(asset('clients/assets/images/video/shape1.png')); ?>" alt="shape">
    </div>
</section>
<!-- Features Area end -->
        ...
        <div class="client-logo-wrap pt-60 pb-55">
            ...
            <div class="client-logo-active">
                <div class="client-logo-item" data-aos="flip-up" data-aos-duration="1500" data-aos-offset="50">
                    <a href="#"><img src="<?php echo e(asset('clients/assets/images/client-logos/client-logo1.png')); ?>"
                            alt="Client Logo"></a>
                </div>
                <div class="client-logo-item" data-aos="flip-up" data-aos-delay="50" data-aos-duration="1500"
                    data-aos-offset="50">
                    <a href="#"><img src="<?php echo e(asset('clients/assets/images/client-logos/client-logo2.png')); ?>"
                            alt="Client Logo"></a>
                </div>
                <div class="client-logo-item" data-aos="flip-up" data-aos-delay="100" data-aos-duration="1500"
                    data-aos-offset="50">
                    <a href="#"><img src="<?php echo e(asset('clients/assets/images/client-logos/client-logo3.png')); ?>"
                            alt="Client Logo"></a>
                </div>
                <div class="client-logo-item" data-aos="flip-up" data-aos-delay="150" data-aos-duration="1500"
                    data-aos-offset="50">
                    <a href="#"><img src="<?php echo e(asset('clients/assets/images/client-logos/client-logo4.png')); ?>"
                            alt="Client Logo"></a>
                </div>
                <div class="client-logo-item" data-aos="flip-up" data-aos-delay="200" data-aos-duration="1500"
                    data-aos-offset="50">
                    <a href="#"><img src="<?php echo e(asset('clients/assets/images/client-logos/client-logo5.png')); ?>"
                            alt="Client Logo"></a>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\travela-master\travela-master\resources\views/clients/about.blade.php ENDPATH**/ ?>