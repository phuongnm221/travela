...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('clients/assets/css/jquery.datetimepicker.min.css')); ?>" />
                    ...
                    <div class="header-inner rel d-flex align-items-center">
                        <div class="logo-outer">
                            <div class="logo"><a href="<?php echo e(route('home')); ?>"><img
                                        src="<?php echo e(asset('clients/assets/images/logos/logo.png')); ?>" alt="Logo"
                                        title="Logo"></a></div>
                        </div>
                                ...
                                <div class="navbar-header">
                                    <div class="mobile-logo">
                                        <a href="<?php echo e(route('home')); ?>">
                                            <img src="<?php echo e(asset('clients/assets/images/logos/logo.png')); ?>"
                                                alt="Logo" title="Logo">
                                        </a>
                                    </div>
                        ...
                        <div class="nav-search">
                            ...
                            <form action="<?php echo e(route('search-voice-text')); ?>" class="hide" method="GET">
                                    ...
                                    <button class="dropdown-toggle bg-transparent" id="userDropdown"
                                        ...
                                        <?php if(session()->has('avatar')): ?>
                                            ...
                                            <img id="avatarPreview" class="img-account-profile rounded-circle"
                                                src="<?php echo e(asset('admin/assets/images/user-profile/' . $avatar)); ?>"
...
<?php /**PATH C:\xampp\htdocs\travela-master\travela-master\resources\views/clients/blocks/header_home.blade.php ENDPATH**/ ?>