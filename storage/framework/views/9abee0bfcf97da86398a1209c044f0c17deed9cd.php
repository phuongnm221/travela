<!-- footer area start -->
<footer class="main-footer footer-two bgp-bottom bgc-black rel z-15 pt-100 pb-115" style="background-image: url(<?php echo e(asset('clients/assets/images/backgrounds/footer-two.png')); ?>);">
                ...
                <div class="col col-small" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <div class="footer-widget footer-text">
                        <div class="footer-logo mb-40">
                            <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('clients/assets/images/logos/logo.png')); ?>" alt="Logo"></a>
                        </div>
...
</html><?php /**PATH C:\xampp\htdocs\travela-master\travela-master\resources\views/clients/blocks/footer.blade.php ENDPATH**/ ?>