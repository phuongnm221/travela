                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content add-tours">
                                ...
                                <div id="wizard" class="form_wizard wizard_horizontal">
                                    ...
                                    <div id="step-1">
                                        <form class="form-info-tour" action="<?php echo e(route('admin.add-tours')); ?>"
                                    ...
                                    <div id="step-2">
                                        ...
                                        <form action="<?php echo e(route('admin.add-images-tours')); ?>"
                                    ...
                                    <form action="<?php echo e(route('admin.add-timeline')); ?>" id="timeline-form" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\travela-master\travela-master\resources\views/admin/add-tours.blade.php ENDPATH**/ ?>