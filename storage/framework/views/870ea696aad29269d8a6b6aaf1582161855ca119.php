            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form action="<?php echo e(route('register.store')); ?>" method="POST" class="register-form" id="register-form" style="margin-top: 15px">
                    ...
                    <div class="signup-image">
                        <figure><img src="<?php echo e(asset('clients/assets/images/login/signup-image.jpg')); ?>"
                                alt="sing up image"></figure>
                        <a href="<?php echo e(route('login')); ?>" class="signup-image-link">Tôi đã có tài khoản rồi</a>
                    </div>
                </div>
            </div>
        </section>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <div id="recaptcha-widget" data-sitekey="<?php echo e(env('RECAPTCHA_SITE_KEY')); ?>"></div>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\travela-master\travela-master\resources\views/clients/register.blade.php ENDPATH**/ ?>