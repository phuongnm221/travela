...
Route::post('/resend-activation', [LoginController::class, 'resendActivationEmail'])->name('resend-activation');
...
Route::post('/forgot-password', [LoginController::class, 'forgotPassword'])->name('forgot-password.store');
...
Route::prefix('admin')->middleware('admin')->group(function () {
    Route::get('/dashboard', [DashboardController::class, 'index'])->middleware('staff.access')->name('admin.dashboard');

    //Profile - for both admin and staff
    Route::get('/profile', [AdminManagementController::class, 'profile'])->name('admin.profile');
    Route::post('/profile/update', [AdminManagementController::class, 'updateProfile'])->name('admin.profile.update');

    //Management admin
    Route::get('/admin', [AdminManagementController::class, 'index'])->middleware('staff.access')->name('admin.admin');
    ...
    Route::get('/users', [UserManagementController::class, 'index'])->middleware('staff.access')->name('admin.users');
    ...
    Route::post('/received-money', [BookingManagementController::class, 'receivedMoney'])->name('admin.received');
    ...
    Route::get('/staff/create', [StaffManagementController::class, 'create'])->name('admin.staff.create');
    Route::post('/staff', [StaffManagementController::class, 'store'])->name('admin.staff.store');
    Route::get('/staff/{id}/edit', [StaffManagementController::class, 'edit'])->name('admin.staff.edit');
    Route::post('/staff/{id}', [StaffManagementController::class, 'update'])->name('admin.staff.update');
    Route::post('/staff/{id}/delete', [StaffManagementController::class, 'destroy'])->name('admin.staff.destroy');
